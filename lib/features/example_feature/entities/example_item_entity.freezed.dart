...
bool operator ==(Object other) {
  final _this = this as ExampleItemEntity;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ExampleItemEntity&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.title, _this.title) || other.title == _this.title)&&(identical(other.description, _this.description) || other.description == _this.description)&&(identical(other.createdAt, _this.createdAt) || other.createdAt == _this.createdAt));
}
...
int get hashCode {
  final _this = this as ExampleItemEntity;
  return Object.hash(runtimeType,_this.id,_this.title,_this.description,_this.createdAt);
}

@override
String toString() {
  final _this = this as ExampleItemEntity;
  return 'ExampleItemEntity(id: ${_this.id}, title: ${_this.title}, description: ${_this.description}, createdAt: ${_this.createdAt})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? description = null,Object? createdAt = null,}) {
  return _then(ExampleItemEntity(
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,title,description,createdAt);
}
