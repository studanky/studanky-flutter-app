...
bool operator ==(Object other) {
  final _this = this as ExampleFeatureState;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ExampleFeatureState&&(identical(other.items, _this.items) || other.items == _this.items)&&(identical(other.searchQuery, _this.searchQuery) || other.searchQuery == _this.searchQuery));
}
...
int get hashCode {
  final _this = this as ExampleFeatureState;
  return Object.hash(runtimeType,_this.items,_this.searchQuery);
}

@override
String toString() {
  final _this = this as ExampleFeatureState;
  return 'ExampleFeatureState(items: ${_this.items}, searchQuery: ${_this.searchQuery})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? items = null,Object? searchQuery = null,}) {
  return _then(ExampleFeatureState(
...
@override
int get hashCode {
    return Object.hash(runtimeType,items,searchQuery);
}
