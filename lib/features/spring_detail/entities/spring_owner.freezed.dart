...
bool operator ==(Object other) {
  final _this = this as SpringOwner;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SpringOwner&&(identical(other.name, _this.name) || other.name == _this.name)&&(identical(other.type, _this.type) || other.type == _this.type));
}
...
String toString() {
  final _this = this as SpringOwner;
  return 'SpringOwner(name: ${_this.name}, type: ${_this.type})';
}
